  ...
  head: () => ({
    meta: [
      ...
      { title: "WorkAI — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Work smarter. Communicate better. Get more done — email drafting, meeting summaries, task planning, research and a workplace chatbot in one dashboard.",
      },
      { name: "author", content: "WorkAI" },
      { property: "og:title", content: "WorkAI — AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "Five AI tools for workplace productivity in one connected dashboard.",
      },
